...
best_color = input('Color: ')
relationship_status = input('Relationship Status: ')
food = input('Food: ')
discipline = input('Course of Study: ')

print('')

Mad_lab1 = ('Your Name is ' + person + ' you are ' + age + 'years old. ''You are currently at ' + address + '. most time i see you wear ' + best_color + ' so i would just assume that is your best color.' ' Love can be sweet so therefore you are mostly ' + relationship_status + ', Your best food should be ' + food + ' While in the university you studied ' + discipline + '.')
